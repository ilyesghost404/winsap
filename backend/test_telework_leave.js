...
async function run() {
  console.log("🚀 Starting Telework Leave Request integration tests...");
  ...
  try {
    ...
    // Simulate validation flow of validateAbsence controller:
    // It calls Absence.validate(id) and skips balance deductions because type is Telework
